...
dojox.data.tests.stores.OpenSearchStore.getAtomStore = function(){
	var store = new dojox.data.OpenSearchStore({url: dojo.moduleUrl('dojox.data.tests.stores', 'opensearch_atom.xml')});
...
dojox.data.tests.stores.OpenSearchStore.getRSSStore = function(){
	var store = new dojox.data.OpenSearchStore({url: dojo.moduleUrl('dojox.data.tests.stores', 'opensearch_rss.xml')});
	store._createSearchUrl = function(request){
...
dojox.data.tests.stores.OpenSearchStore.getHTMLStore = function(){
	var store = new dojox.data.OpenSearchStore({url: dojo.moduleUrl('dojox.data.tests.stores', 'opensearch_html.xml'), itemPath: "table tbody tr"});
	store._createSearchUrl = function(request){
